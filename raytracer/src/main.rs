...
fn main() {
    ...
    for j in 0..height {
        for i in 0..width {
            ...
            let r = ray::Ray::new(origin, lower_left_corner + horizontal * u + vertical * v - origin, 0.0);
            let pixel_color = ray_color(&r);            
            write_color([(pixel_color.x * 255.99) as u8, (pixel_color.y * 255.99) as u8, (pixel_color.z * 255.99) as u8], &mut img, i, height - j - 1);
            bar.inc(1);
        }
    }
